...
namespace Proiect_II.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Comment,Rating,Date")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comment,Rating,Date")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
